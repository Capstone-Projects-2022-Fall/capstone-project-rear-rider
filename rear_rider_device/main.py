...
def main():
    ...
    lidar_child_proc = LidarChildProcess(led_child_proc=leds_child_proc, camera_child_proc=camera_proc, bluetooth_server_child_proc=BluetoothServerChildProcess)
